...
static const mrb_code new_kwless_iseq[] = {
...
static const mrb_irep new_irep = {
    4,    6,    0,    MRB_IREP_STATIC,  new_iseq, NULL, new_syms,
    NULL, NULL, NULL, sizeof(new_iseq), 0,        2,    0,
    0,
};

static const mrb_irep new_kwless_irep = {
  4, 6, 0, MRB_IREP_STATIC,
  new_kwless_iseq, NULL, new_syms, NULL, NULL, NULL,
...
static const struct RProc new_kwless_proc = {
  NULL, NULL, MRB_TT_PROC, MRB_GC_RED, MRB_FL_OBJ_IS_FROZEN | MRB_PROC_SCOPE | MRB_PROC_STRICT,
